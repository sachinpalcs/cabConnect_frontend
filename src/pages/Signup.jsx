...
//                 onChange={handleChange}
//                 className={`block w-full rounded-md border px-3 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-gray-500 ${
...
//           <a href="/login" className="text-black font-semibold text-base hover:underline">
//             Log in
//           </a>
//         </p>
//       </div>
...
const Signup = () => {
    ...
    // Effect to handle redirection and messages after API call
    useEffect(() => {
        if (isError) {
            // For a better user experience, you could replace this with a toast notification
            alert(message);
        }
        ...
        // Reset the auth state after handling the side effects
        dispatch(reset());
    ...
    const handleSubmit = (e) => {
        ...
        // Prepare the data transfer object (DTO) for the API
        const signupDto = {
            name: form.name,
            email: form.email,
